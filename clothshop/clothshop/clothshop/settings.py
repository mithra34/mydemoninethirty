...
SECRET_KEY = 'django-insecure-_&5@gnf5$)lja+z^%^p!b4q=sckj9^vfs6+(^uc5^e+-vzonss'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'clothshop/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATICFILES_DIRS=[os.path.join(BASE_DIR, 'clothshop/static')]
